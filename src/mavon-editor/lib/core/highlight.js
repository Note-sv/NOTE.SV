  ...
  if (pre_code && hljs && (typeof hljsLangFuc === 'function')) {
    ...
    for (i = 0; i < pre_code.length; i++) {
      ...
      if (lang.length > 0) {
        ...
        if (!hljs.getLanguage(lang) && !Object.prototype.hasOwnProperty.call(not_include_lang, lang) && url.length > 0) {
    ...
    for (var key in not_include_lang) {
      if (Object.prototype.hasOwnProperty.call(not_include_lang, key)) {
        need_langs.push(key)
      }
    }
