...
function bridgeListener ( channelName, data ) {
  if ( channels && Object.prototype.hasOwnProperty.call(channels, channelName) ) {
...
const dbChannel = new EventChannel( DB_CHANNEL )
registerChannel( dbChannel )
